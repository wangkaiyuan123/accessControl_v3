        	...
        	<div class="layui-form-item">
        		...
        		<div class="layui-inline">
        			<label class="layui-form-label">
        				<button class="layui-btn layui-btn-danger resetWeiXin" type="button" id="reset">清空选择</button>	
        			</label>
        		</div>	
        	</div>
        	<div class="layui-form-item">
       ...
       <script type="text/javascript">
       		layui.use('form', function() {
				...
				$("#reset").click(function(){
      			...
      			loadTree();
      			var submitForm =new submitObj({"type":"post","url":contextPath+"/sysResource/saveRecource","refresh":true,"Isform":true});
