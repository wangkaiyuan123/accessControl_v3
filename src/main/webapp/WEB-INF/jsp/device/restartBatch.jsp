  ...
  <body>
   	...
   	<script type="text/javascript">
   		...
   		layui.use('layer', function(){
   			...
   			var $ = layui.$;
   			var submitForm =new submitObj({"type":"post","data":{'deviceIds':deviceIds.substring(1,deviceIds.length-1)},"url":contextPath+"/device/restart","refresh":true,"Isform":false});
   			submitForm.submit();	
   		})
   	</script>
  </body>
